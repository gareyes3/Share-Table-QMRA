...
for (i in 1:100){
Individual_Analysis_Fr_Consumed_W<-Func_DR_Infection(Individual_Analysis_Fr_Consumed_W)
Individual_Analysis_Fr_Consumed_W<-Func_DR_Illness(Individual_Analysis_Fr_Consumed_W)

#Number of Items per category
Number_Inf_W<-sum(Individual_Analysis_Fr_Consumed_W$Infection==TRUE)
Vec_Infected_W<-c(Vec_Infected_W,Number_Inf_W)

Number_Ill_W<-sum(Individual_Analysis_Fr_Consumed_W$Illness==TRUE)
