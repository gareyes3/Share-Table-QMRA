...
ST_Comb_Analysis_Log<-bind_rows(ST_ON_Analysis_Log,ST_OFF_Analysis_Log,ST_ONWash_Analysis_Log,ST_ONWr_Analysis_Log,ST_OFFWash_Analysis_Log,ST_OFFWr_Analysis_Log,ST_Exc_Analysis_Log,ST_STClosed_Analysis_Log,ST_STAside_Analysis_Log,ST_WStation_Analysis_Log,ST_WBucket_Analysis_Log)
...
ggsave(filename = "FoodSecFin4.png", path = pathfolder,width = 8,height = 7,)
...
ggsave(filename = "FoodSecFin6.png", path = pathfolder,width = 8,height = 8,)
