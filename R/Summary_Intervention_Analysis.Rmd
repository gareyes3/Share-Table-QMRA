...
g+
   ...
   annotate("rect", xmin = -Inf, xmax = Inf, ymin = c(0.01079137,0.01204819), ymax = c(0.01836394,0.01929346),
           alpha = .2,fill = c("red", "blue"))+
  geom_hline(yintercept=c(0.01079137,0.01836394,0.01204819,0.01929346), linetype=c("dashed",'dashed','dotted','dotted'), 
  ...
  ggsave(filename = "Boxplot_Prevalence.png", path = "C:/Users/gareyes3/Box Sync/Share Table Project/QMRA Files/QMRA Paper/MRA Submission/Figures-R1",width = 10,height = 10,)
