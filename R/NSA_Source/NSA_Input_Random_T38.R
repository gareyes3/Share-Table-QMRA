...
#Behavioral Inputs: 
  ...
  Pr_eat_ST_Fr<-0.8#rpert(1,min=0.7, mode= 0.8,max =0.9,4)
  Pr_eat_ST_Pss<-0.8#rpert(1,min=0.7, mode= 0.8,max =0.9,4)
  Pr_eat_ST_Pre<-0.8#rpert(1,min=0.7, mode= 0.8,max =0.9,4)
