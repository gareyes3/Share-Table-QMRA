...
#Behavioral Inputs: 
  ...
  Pr_Pick_ST_Fr<-0.15#rpert(1,min=0.05, mode= 0.1,max =0.15,4)
  Pr_Pick_ST_Pss<-0.15#rpert(1,min=0.05, mode= 0.1,max =0.15,4)
  Pr_Pick_ST_Pre<-0.15#rpert(1,min=0.05, mode= 0.1,max =0.15,4)
