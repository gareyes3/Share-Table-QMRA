...
ggsave(filename = "Food_sec.png", path = "Dose Response",width = 8,height = 6,)
print(Food_sec)
...
ggsave(filename = "Wrapped_Histograms.png", path = "Dose Response",width = 10,height = 10,)
...
ggsave(filename = "barchart_Expos.png", path = "Dose Response",width = 10,height = 6,)
...
ggsave(filename = "Barchart_Expos2.png", path = "Dose Response",width = 8,height = 6,)
