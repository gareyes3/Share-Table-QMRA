...
ggsave(plot = Tails_prev3,filename = "Tails_prev3.png", path = "Dose Response",width = 10,height = 6,)
print(Tails_prev3)
...
ggsave(filename = "FoodSecFin.png", path = "Dose Response",width = 10,height = 6,)
