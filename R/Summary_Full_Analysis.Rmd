...
ggsave(filename = "Dose_Hist_Stacked2.png", path = "Dose Response",width = 10,height = 6,)
...
ggsave(filename = "Facet_DR_Hist2.png", path = "Dose Response",width = 10,height = 10,)
print(Facet_DR_Hist)
...
ggsave(filename = "Tails_prev2.png", path = "Dose Response",width = 10,height = 6,)
print(Tails_prev)
